...
public class SqlStorage implements Storage {
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO section (resume_uuid, type, content) VALUES (?, ?, ?)")) {
                    ...
                    for (Map.Entry<SectionType, Section> sectionEntry : sections.entrySet()) {
                        ...
                        if (sectionType.equals(SectionType.EXPERIENCE) || sectionType.equals(SectionType.EDUCATION)) {
                            ...
                            insertOrganizationSectionsToDB(connection, section0, section_id);
                            continue;
                        }
                    }
                    preparedStatement.executeBatch();
    ...
    private void insertOrganizationSectionsToDB(Connection connection, OrganizationSection section0, Integer section_id) throws SQLException {
        ...
        try (PreparedStatement preparedStatement1 = connection.prepareStatement
            ...
            for (Organization organization : organizations) {
                ...
                insertRecordsToDB(connection, organization, organisation_id);
            }
        }
    }

    private void insertRecordsToDB(Connection connection, Organization organization, Integer organisation_id) throws SQLException {
    ...
    public Resume get(String uuid) {
        return doExecute("SELECT * FROM resume AS r " +
            ...
            fillResumeWithSectionsFromDB(connection, resume);

            return resume;
        });
    }

    private void fillResumeWithSectionsFromDB(Connection connection, Resume resume) throws SQLException {
        try (PreparedStatement preparedStatement1 = connection.prepareStatement
            ...
            if (resultSet1.next()) {
                do {
                    ...
                    if (SectionType.valueOf(sectionType).equals(EXPERIENCE) ||
                        ...
                        fillResumeWithOrganizationSectionsFromDB(connection, resume, section_id, sectionType);
                    }
    ...
    private void fillResumeWithOrganizationSectionsFromDB(Connection connection,
                                                          Resume resume,
                                                          Integer section_id,
        ...
        try (PreparedStatement preparedStatement2 = connection.prepareStatement
            ...
            if (resultSet2.next()) {
                List<Organization> organizations = getOrganizationsFromDB(connection, resultSet2);
    ...
    private List<Organization> getOrganizationsFromDB(Connection connection,
        ...
        do {
            ...
            getRecordsFromDB(connection, organisation_id, records);
    ...
    private void getRecordsFromDB(Connection connection,
                                  Integer organisation_id,
                                  List<Organization.Record> records) throws SQLException {
